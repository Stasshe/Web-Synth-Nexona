...
function serializeOsc(osc: typeof synthState.oscillators.a) {
  return {
    ...
    unisonBlend: osc.unisonBlend,
    unisonStackType: osc.unisonStackType,
    unisonDetunePower: osc.unisonDetunePower,
    unisonDetuneRange: osc.unisonDetuneRange,
    unisonFrameSpread: osc.unisonFrameSpread,
    unisonSpectralMorphSpread: osc.unisonSpectralMorphSpread,
    unisonDistortionSpread: osc.unisonDistortionSpread,
    pan: osc.pan,
    distortionType: osc.distortionType,
    distortionAmount: osc.distortionAmount,
    distortionPhase: osc.distortionPhase,
