...
export const SPECTRAL_MORPH_NAMES: Record<number, string> = {
  ...
  [SpectralMorphType.HARMONIC_SCALE]: "Harmonic Scale",
  [SpectralMorphType.INHARMONIC_SCALE]: "Inharmonic Scale",
  [SpectralMorphType.SMEAR]: "Smear",
  [SpectralMorphType.RANDOM_AMPLITUDES]: "Random Amp",
  [SpectralMorphType.LOW_PASS]: "Low Pass",
  [SpectralMorphType.HIGH_PASS]: "High Pass",
  [SpectralMorphType.PHASE_DISPERSE]: "Phase Disperse",
  [SpectralMorphType.SHEPARD_TONE]: "Shepard Tone",
  [SpectralMorphType.SKEW]: "Skew",
};
