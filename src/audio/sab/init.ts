...
export function createSAB(): SharedArrayBuffer {
  ...
  setParam(view, SabParam.OscATune, 0);
  setParam(view, SabParam.OscATranspose, 0);
  setParam(view, SabParam.OscAUnisonVoices, 1);
  setParam(view, SabParam.OscAUnisonDetune, 0.2);
  setParam(view, SabParam.OscAUnisonSpread, 0.5);
  setParam(view, SabParam.OscAUnisonBlend, 0.8);
  setParam(view, SabParam.OscAUnisonStackType, 0);
  setParam(view, SabParam.OscAUnisonDetunePower, 1.5);
  setParam(view, SabParam.OscADetuneRange, 2);
  setParam(view, SabParam.OscAFrameSpread, 0);
  setParam(view, SabParam.OscAPan, 0);
  setParam(view, SabParam.OscADistortionType, 0);
  setParam(view, SabParam.OscADistortionAmount, 0);
  setParam(view, SabParam.OscADistortionPhase, 0.5);
  setParam(view, SabParam.OscADestination, 0);
  ...
  setParam(view, SabParam.OscBTune, 0);
  setParam(view, SabParam.OscBTranspose, 0);
  setParam(view, SabParam.OscBUnisonVoices, 1);
  setParam(view, SabParam.OscBUnisonDetune, 0.2);
  setParam(view, SabParam.OscBUnisonSpread, 0.5);
  setParam(view, SabParam.OscBUnisonBlend, 0.8);
  setParam(view, SabParam.OscBUnisonStackType, 0);
  setParam(view, SabParam.OscBUnisonDetunePower, 1.5);
  setParam(view, SabParam.OscBDetuneRange, 2);
  setParam(view, SabParam.OscBFrameSpread, 0);
  setParam(view, SabParam.OscBPan, 0);
  setParam(view, SabParam.OscBDistortionType, 0);
  setParam(view, SabParam.OscBDistortionAmount, 0);
  setParam(view, SabParam.OscBDistortionPhase, 0.5);
  setParam(view, SabParam.OscBDestination, 0);
  ...
  setParam(view, SabParam.OscCTune, 0);
  setParam(view, SabParam.OscCTranspose, 0);
  setParam(view, SabParam.OscCUnisonVoices, 1);
  setParam(view, SabParam.OscCUnisonDetune, 0.2);
  setParam(view, SabParam.OscCUnisonSpread, 0.5);
  setParam(view, SabParam.OscCUnisonBlend, 0.8);
  setParam(view, SabParam.OscCUnisonStackType, 0);
  setParam(view, SabParam.OscCUnisonDetunePower, 1.5);
  setParam(view, SabParam.OscCDetuneRange, 2);
  setParam(view, SabParam.OscCFrameSpread, 0);
  setParam(view, SabParam.OscCPan, 0);
  setParam(view, SabParam.OscCDistortionType, 0);
  setParam(view, SabParam.OscCDistortionAmount, 0);
  setParam(view, SabParam.OscCDistortionPhase, 0.5);
  setParam(view, SabParam.OscCDestination, 0);
